...
describe('Admin Panel features', () => {
    ...
    it('C29684 Admin Panel: Verify Pending Tab Order Detail action works', async () => {
        ...
        const orderDetailsHeaderText: string = await adminPage.orderDetailsPageHeader.getText()
        ...
        const paymentStatus: string = await adminPage.orderPaymentTotalStatus.getText()
        ...
        const isTrackingOptions: boolean = await adminPage.validateTrackHistoryOptions()
