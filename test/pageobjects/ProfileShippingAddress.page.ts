...
class ProfileShippingAddress extends Page {
  ...
  public get ship_save_address_btn() {
    return $("//div[contains(@class,'row-custom ShippingAddress_btn-group')]/div[2]/button")
  }
  ...
  public async addShippingAddress() {
    const shippingData = JSON.parse(fs.readFileSync('./test/data/profile_shipping.json', 'utf-8'))
